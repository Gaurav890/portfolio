...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    challenge: 'Ironfish, a real estate investment firm, had invested heavily in content but saw minimal organic traffic. Despite quality content, they were invisible in search results. The site was slow, had indexing issues, and lacked technical SEO foundation.',
    approach: [
  ...
  {
    id: '3',
    slug: 'flare-hr-marketing-velocity',
    title: 'Flare HR',
    ...
    challenge: 'Flare HR\'s marketing team was stuck. Campaign launches took weeks instead of days. The website had persistent technical issues. Analytics were unreliable. The team couldn\'t move fast enough to test ideas or respond to market opportunities.',
    approach: [
  ...
  },
  {
    ...
    challenge: 'Lawyerly, a legal news platform, faced frequent downtime and slow load times. Readers were frustrated. Editorial team couldn\'t publish reliably. The platform was losing credibility and traffic due to technical unreliability.',
    approach: [
  ...
  },
  {
    ...
    summary: 'Redesigned RTO Works\' website to build trust and improve conversion rates. Achieved +27.9% increase in phone inquiries through modern design, social proof, and streamlined user experience.',
    challenge: 'RTO Works, a corporate training provider, had an outdated website that didn\'t reflect their expertise. Visitors bounced quickly. Phone inquiries were declining. The site lacked credibility signals and had a confusing navigation structure.',
    approach: [
  ...
  {
    id: '6',
    slug: 'tile-factory-reliability-revenue',
    title: 'Tile Factory Outlet',
    ...
    challenge: 'Tile Factory Outlet\'s e-commerce site was plagued by technical issues: slow load times, broken product pages, cart abandonment. Customers couldn\'t reliably complete purchases. Revenue was stagnating despite strong brand reputation.',
    approach: [
